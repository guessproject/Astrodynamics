...
def solve(mu, r1, r2, t_sec, orb_type, path, m):
	...
	#Args:
		...
		# m:         number of revolutions
	#Returns:
		# v1_list:   velocities at position 1
		# v2_list:   velocities at position 2
	##########################################
...
def get_transfer_angle(orb_type, m, r1, r2):
	...
	#Args:
		...
		# psi:       transfer angle
	#Returns:
		# h:         angular momentum of the transfer orbit
		#psi:        angular displacement of the transfer orbit
	##########################################
